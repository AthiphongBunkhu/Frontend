...
data () {
    ...
    async mounted(){
      await axios.get('http://env-1489426.app.ruk-com.cloud/getRoom/6271468ee54c1af0f7ca04d8')
      .then((res) => {
    ...
    create(){
        axios.get('http://env-1489426.app.ruk-com.cloud/edit-room/6271468ee54c1af0f7ca04d8')
        .then((res) => {
            this.room = res.data.result
        })
    },
    methods: {
        updateRoom(){
            axios.put('http://env-1489426.app.ruk-com.cloud/update-room/6271468ee54c1af0f7ca04d8',this.room)
            .then((res) => {
                console.log(res)

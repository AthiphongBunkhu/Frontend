...
data () {
    ...
    create(){
        axios.get('http://env-1489426.app.ruk-com.cloud/edit-room/62714688e54c1af0f7ca04d4')
        .then((res) => {
            this.room = res.data.result
        })
    },
    methods: {
        updateRoom(){
            axios.put('http://env-1489426.app.ruk-com.cloud/update-room/62714688e54c1af0f7ca04d4',this.room)
            .then((res) => {
                console.log(res)
                this.$router.push( '/room09' )
            }).catch(error =>{
                console.log(error)
            })
        },

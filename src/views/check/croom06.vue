...
data () {
    ...
    async mounted(){
      await axios.get('http://env-1489426.app.ruk-com.cloud/getRoom/62714672e54c1af0f7ca04ce')
      .then((res) => {
    ...
    create(){
        axios.get('http://env-1489426.app.ruk-com.cloud/edit-room/62714672e54c1af0f7ca04ce')
        .then((res) => {
            this.room = res.data.result
        })
    },
    methods: {
        updateRoom(){
            axios.put('http://env-1489426.app.ruk-com.cloud/update-room/62714672e54c1af0f7ca04ce',this.room)
            .then((res) => {
                console.log(res)
                this.$router.push( '/room06' )
            }).catch(error =>{
                console.log(error)
            })
        },

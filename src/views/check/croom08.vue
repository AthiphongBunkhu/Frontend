...
data () {
    ...
    async mounted(){
      await axios.get('http://env-1489426.app.ruk-com.cloud/getRoom/62714677e54c1af0f7ca04d2')
      .then((res) => {
    ...
    create(){
        axios.get('http://env-1489426.app.ruk-com.cloud/edit-room/62714677e54c1af0f7ca04d2')
        .then((res) => {
            this.room = res.data.result
        })
    },
    methods: {
        updateRoom(){
            axios.put('http://env-1489426.app.ruk-com.cloud/update-room/62714677e54c1af0f7ca04d2',this.room)
            .then((res) => {
                console.log(res)
                this.$router.push( '/room08' )
            }).catch(error =>{
                console.log(error)
            })
        },

...
data () {
    ...
    async mounted(){
      await axios.get('http://env-1489426.app.ruk-com.cloud/getRoom/62714690e54c1af0f7ca04da')
      .then((res) => {
    ...
    create(){
        axios.get('http://env-1489426.app.ruk-com.cloud/edit-room/62714690e54c1af0f7ca04da')
        .then((res) => {
            this.room = res.data.result
        })
    },
    methods: {
        updateRoom(){
            axios.put('http://env-1489426.app.ruk-com.cloud/update-room/62714690e54c1af0f7ca04da',this.room)
            .then((res) => {
                console.log(res)
                this.$router.push( '/room12' )
            }).catch(error =>{
                console.log(error)
            })
        },
